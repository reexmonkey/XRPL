namespace XRPL.Core.Domain.Entries
{
    ...
    public class DID : LedgerEntry
    {
        ...
        /// <para/>
        /// This field can be an HTTP(S) URL or IPFS URI. This field isn't checked for validity and is limited to a maximum length of 256 bytes.
        /// </summary>
        public string? URI { get; set; }

        public DID() => LedgerEntryType = nameof(DID);
    }

    /// <summary>
    /// Represents metadata associated with a <see cref="DID"/> ledger entry.
    /// </summary>
    public class DIDMeta : LedgerEntryMeta
    {
        /// <summary>
        /// The account that controls the DID.
        /// </summary>
