...
namespace XRPL.Core.Domain.Entries
{
    ...
    /// </summary>
    public class NFTokenPage : LedgerEntry
    {
        /// <summary>
        ...
        /// </summary>
        public NFTokenPage() => LedgerEntryType = nameof(NFTokenPage);
    }

    /// <summary>
    /// Represents metadata associated with a <see cref="NFTokenPage"/> ledger entry.
    /// </summary>
    public class NFTokenPageMeta : LedgerEntryMeta
    {
        /// <summary>
