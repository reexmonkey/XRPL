...
namespace XRPL.Core.Domain.Entries
{
    ...
    /// </summary>
    public class RippleState : LedgerEntry
    {
        ...
        /// </summary>
        public required object Balance { get; set; }
        ...
        /// </summary>
        public required object HighLimit { get; set; }
        ...
        /// </summary>
        public required object HighNode { get; set; }
        ...
        /// </summary>
        public object? HighQualityIn { get; set; }
        ...
        /// </summary>
        public required object LowLimit { get; set; }
        ...
        /// </summary>
        public required object LowNode { get; set; }
        ...
        /// </summary>
        public required object PreviousTxnID { get; set; }
        ...
        /// </summary>
        public required override uint Flags { get => (uint)flags; set => flags = (RippleStateFlags)value; }

        /// <summary>
        /// Initialize a new instance of the <see cref="RippleState"/> class.
        /// </summary>
        public RippleState() => LedgerEntryType = nameof(RippleState);
    }
    ...
    /// <summary>
    /// Represents metadata associated with a <see cref="RippleState"/> ledger entry.
    /// </summary>
    public class RippleStateMeta : LedgerEntryMeta
    {
        /// <summary>
        /// The balance of the trust line, from the perspective of the low account.
        /// </summary>
        ...
        /// <summary>
        /// A hint indicating which page of the high account's owner directory links to this entry, in case the directory consists of multiple pages.
        /// </summary>
        public object? HighNode { get; set; }
        ...
        /// <summary>
        /// A hint indicating which page of the low account's owner directory links to this entry, in case the directory consists of multiple pages.
        /// </summary>
        public object? LowNode { get; set; }
    ...
    [JsonSerializable(typeof(TokenAmount))]
    [JsonSerializable(typeof(MPTAmount))]
    public partial class RippleStateMetaContext : JsonSerializerContext;
}
