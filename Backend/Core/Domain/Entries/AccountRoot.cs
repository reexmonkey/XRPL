namespace XRPL.Core.Domain.Entries
{
    ...
    /// </summary>
    public class AccountRoot : LedgerEntry
    {
        ...
        /// <para/>
        /// This field must be enabled to use the <see cref="AccountTxnID"/> transaction field. To enable it, send an AccountSet transaction with the asfAccountTxnID flag enabled.
        /// </summary>
        ...
        /// <para/>
        /// Set during account creation; cannot be modified. If present, indicates that this is a special AMM AccountRoot; always omitted on non-AMM accounts.
        /// </summary>
        ...
        /// <para/>
        /// In JSON, this is the hexadecimal for the ASCII representation of the domain. Cannot be more than 256 bytes in length.
        /// </summary>
        ...
        /// </summary>
        public required uint OwnerCount { get; set; }
        ...
        /// <para/>
        /// This is updated automatically to ensure that the account stays within the hard limit of 250 Tickets at a time. This field is omitted if the account has zero Tickets.
        /// </summary>
        ...
        /// </summary>
        public required override uint Flags { get => (uint)flags; set => flags = (AccountRootFlags)value; }

        /// <summary>
        /// Initializes a new instance of the <see cref="AccountRoot"/> class.
        /// </summary>
        public AccountRoot() => LedgerEntryType = nameof(AccountRoot);
    }
    ...
    public enum AccountRootFlags : uint
    {
        ...
        /// <para/>
        /// (Advisory; not enforced by the protocol.)
        /// </summary>
    ...
    /// <summary>
    /// Represents a metadata entry that describes a single account.
    /// </summary>
    public class AccountRootMeta : LedgerEntryMeta
    {
        /// <summary>
        /// The identifying (classic) address of this account.
        /// </summary>
