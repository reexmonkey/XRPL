...
namespace XRPL.Core.Domain.Entries
{
    ...
    public class AMM
    {
        ...
        /// </summary>
        public required CurrencyAmount LPTokenBalance { get; set; }
    ...
    public class AuctionSlot
    {
        ...
        /// </summary>
        public required string DiscountedFee { get; set; }

        /// <summary>
        /// The amount the auction owner paid to win this slot, in LP Tokens.
        /// </summary>
        public required CurrencyAmount Price { get; set; }
    ...
    [JsonSerializable(typeof(AuctionSlot))]
    [JsonSerializable(typeof(XRPAmount))]
    [JsonSerializable(typeof(TokenAmount))]
    [JsonSerializable(typeof(MPTAmount))]
    public partial class AuctionSlotContext : JsonSerializerContext;

    /// <summary>
    /// Represents the metadata for an Automated Market Maker (AMM) instance, including details about the assets held,
    /// account information, and liquidity provider token balances.
    /// </summary>
    public class AMMMeta : LedgerEntryMeta
    {
        /// <summary>
        /// The definition for one of the two assets this AMM holds.
        /// <para/>
    ...
    [JsonSerializable(typeof(TokenAmount))]
    [JsonSerializable(typeof(MPTAmount))]
    public partial class AMMMetaContext : JsonSerializerContext;
}
