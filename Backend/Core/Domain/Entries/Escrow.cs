...
namespace XRPL.Core.Domain.Entries
{
    ...
    /// </summary>
    public class Escrow : LedgerEntry
    {
        /// <summary>
        ...
        /// <para/>
        /// Omitted on escrows created before enabling the fix1523 amendment.
        /// </summary>
        ...
        /// </summary>
        public ulong IssuerNode { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="Escrow"/> class.
        /// </summary>
        public Escrow() => LedgerEntryType = nameof(Escrow);
    }
    ...
    /// <summary>
    /// Represents metadata associated with an <see cref="Escrow"/> ledger entry.
    /// </summary>
    public class EscrowMeta : LedgerEntryMeta
    {
        /// <summary>
        /// The address of the owner (sender) of this escrow. This is the account that provided the XRP, and gets it back if the escrow is canceled.
        /// </summary>
    ...
    [JsonSerializable(typeof(TokenAmount))]
    [JsonSerializable(typeof(MPTAmount))]
    public partial class EscrowMetaContext : JsonSerializerContext
    {
    }
}
