...
namespace XRPL.Core.Domain.Transactions
{
    ...
    /// it may stop before fully removing the AMM. Similarly, an <see cref="AMMDelete"/> transaction removes up to a maximum of 512 trust lines;
    /// it may take several <see cref="AMMDelete"/> transactions to delete all the trust lines and the associated AMM.
    /// <para/>In all cases, only the last such transaction deletes the AMM and <see cref="AccountRoot"/> ledger entries.
    /// </summary>
    public class AMMDelete : Transaction
    {
        ...
        /// </summary>
        public AMMDelete() : base(TransactionType.AMMDelete)
        {
        }
    }
    ...
    public partial class AMMDeleteContext : JsonSerializerContext;
}