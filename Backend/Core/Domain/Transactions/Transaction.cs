...
{
    /// <summary>
    /// Specifies a transaction, which is the only way to cause changes in the XRPL ledeger.
    ...
    public abstract class Transaction(TransactionType transactionType)
    {
        ...
        /// </summary>
        public required virtual string Account { get; set; }
        ...
        public required TransactionMetadata Meta { get; set; }
    }
    ...
    public enum NetworkID
    {
        ...
        /// <summary>
        /// Batch Testnet - Required
        /// </summary>
        Batch_Testnet = 21336,

        /// <summary>
        /// Xauhau Mainnet - Required
        /// </summary>
        Xahau_Mainnet = 21337,

        /// <summary>
        /// Xauhau Testnet - Required
        /// </summary>
        Xahau_Testnet = 21338,
    ...
    /// <summary>
    /// Defines the flags that apply globally to all transactions.
    /// </summary>
