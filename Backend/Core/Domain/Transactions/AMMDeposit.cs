...
namespace XRPL.Core.Domain.Transactions
{
    ...
    /// </summary>
    public class AMMDeposit : Transaction
    {
        private AMMDepositFlags? flags;
        ...
        /// </summary>
        public CurrencyAmount? LPTokenOut { get; set; }

        public override uint? Flags { get => (uint?)flags; set => flags = (AMMDepositFlags?)value; }

        /// <summary>
        /// Initializes a new instance of the <see cref="AMMDeposit"/> class.
        /// </summary>
        public AMMDeposit() : base(TransactionType.AMMDeposit)
        {
        }
    }
