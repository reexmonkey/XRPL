...
namespace XRPL.Core.Domain.Methods.JsonRpc.AccountMethods
{
    ...
    /// </summary>
    public record NoRippleCheckRequest : Request, IExpect<NoRippleCheckResponse>
    {
        /// <summary>
        /// Gets the collection of parameters used to configure the no ripple check operation.
        /// </summary>
        [JsonPropertyName("params")]
        public NoRippleCheckParameters[]? Parameters { get; init; }

        /// <summary>
        /// Initializes a new instance of the <see cref="NoRippleCheckRequest"/> record.
        /// </summary>
    ...
    /// </summary>
    public record NoRippleCheckParameters : Parameter
    {
        /// <summary>
        ...
        public uint? Limit { get; init; } = 300;
