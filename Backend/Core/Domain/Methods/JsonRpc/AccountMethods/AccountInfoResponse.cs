...
namespace XRPL.Core.Domain.Methods.JsonRpc.AccountMethods
{
    ...
    /// </summary>
    public record AccountInfoResponse : Response
    {
        /// <summary>
        /// The result of the query; contents vary depending on the command.
        /// </summary>
        [JsonPropertyName("result")]
        public required AccountInfoResult Result { get; set; }
    }

    /// <summary>
    /// Represents the result of an <see cref="AccountInfoResponse"/> object.
    /// </summary>
    public record AccountInfoResult : Result
    {
        /// <summary>
        /// The AccountRoot ledger object with this account's information, as stored in the ledger.
        /// </summary>
        [JsonPropertyName("account_data")]
        public required AccountRoot AccountData { get; init; }

        /// <summary>
        /// The account's flag statuses (see below), based on the <see cref="LedgerEntry.Flags"/> field of the account.
        /// </summary>
        [JsonPropertyName("account_flags")]
        public required AccountFlags AccountFlags { get; init; }
        ...
        public SignerList[]? SignerLists { get; init; }
    ...
    /// <summary>
    /// Represents the statuses of an account based on the <see cref="LedgerEntry.Flags"/> field of the account.
    /// </summary>
    public record AccountFlags
    {
        ...
        public bool? DisableMasterKey { get; init; }
        ...
        public bool? DisallowIncomingCheck { get; init; }
        ...
        public bool? DisallowIncomingNFTokenOffer { get; init; }
        ...
        public bool? DisallowIncomingPayChan { get; init; }
        ...
        public bool? DisallowIncomingXRP { get; init; }
        ...
        public bool? PasswordSpent { get; init; }
    ...
    public record QueueData
    {
        ...
        /// </summary>
        public TransactionQueueData[]? Transactions { get; init; }
    }

    /// <summary>
    /// Represents the information associated with a queued transaction.
    /// </summary>
    public record TransactionQueueData
    {
        /// <summary>
