...
namespace XRPL.Core.Domain.Methods.JsonRpc.AccountMethods
{
    ...
    /// </summary>
    public record AccountObjectsRequest : Request, IExpect<AccountObjectsResponse>
    {
        /// <summary>
        /// Gets the array of parameters used to configure or modify the behavior of account objects.
        /// </summary>
        /// <remarks>This property may be null if no parameters are specified. Use these parameters to
        /// customize account object requests according to application requirements.</remarks>
        [JsonPropertyName("params")]
        public AccountObjectsParameters[]? Parameters { get; init; }

        /// <summary>
        /// Initializes a new instance of the <see cref="AccountObjectsRequest"/> record.
        /// </summary>
    ...
    /// </summary>
    public record AccountObjectsParameters : Parameter
    {
        /// <summary>
        ...
        public bool? DeletionBlockersOnly { get; init; }
