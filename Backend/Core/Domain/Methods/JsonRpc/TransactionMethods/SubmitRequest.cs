...
namespace XRPL.Core.Domain.Methods.JsonRpc.TransactionMethods
{
    ...
    /// </summary>
    public record SubmitOnlyRequest : Request, IExpect<SubmitResponse>
    {
        [JsonPropertyName("params")]
        public SubmitOnlyParameter[]? Parameters { get; init; }

        /// <summary>
        /// Initializes a new instance of the <see cref="SubmitOnlyRequest"/> record.
        /// </summary>
    ...
    public record SubmitOnlyParameter : Parameter
    {
        /// <summary>
    ...
    public record SignAndSubmitRequest : Request, IExpect<SubmitResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignAndSubmitRequest"/> record.
        /// </summary>
    ...
    /// </summary>
    public abstract record SignAndSubmitParameter : Parameter
    {
        /// <summary>
        ...
        /// <summary>
        /// Specifies where in the transaction metadata the signature information should be stored.
        /// <para/> Currently, the only valid value is CounterpartySignature
        /// </summary>
        [JsonPropertyName("signature_target")]
        public string? SignatureTarget { get; init; }
        ...
        public bool? BuildPath { get; init; }
        ...
        public int? FeeMultMax { get; init; }
        ...
        public int? FeeDivMax { get; init; }
    }

    /// <summary>
    /// Represents the parameters of an <see cref="SignAndSubmitRequest"/> object.
    /// </summary>
    public record SecretSignAndSubmitParameter : SignAndSubmitParameter
    {
        /// <summary>
    ...
    /// Represents the parameters of an <see cref="SignAndSubmitRequest"/> object.
    /// </summary>
    public record SeedSignAndSubmitParameter : SignAndSubmitParameter
    {
        /// <summary>
    ...
    /// </summary>
    public record SeedHexSignAndSubmitParameter : SignAndSubmitParameter
    {
        /// <summary>
        /// (Optional) Secret key of the account supplying the transaction, used to sign it.
    ...
    /// </summary>
    public record PassphraseSignAndSubmitParameter : SignAndSubmitParameter
    {
        /// <summary>
