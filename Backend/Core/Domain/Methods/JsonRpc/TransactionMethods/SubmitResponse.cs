...
namespace XRPL.Core.Domain.Methods.JsonRpc.TransactionMethods
{
    ...
    /// </summary>
    public record SubmitResponse : Response
    {
        /// <summary>
        /// Gets the result of the submit operation, including the outcome and any relevant details.
        /// </summary>
        [JsonPropertyName("result")]
        public required SubmitResult Result { get; init; }
    }
    ...
    /// </summary>
    public record SubmitResult : Result
    {
        /// <summary>
        ...
        public uint? AccountSequenceAvailable { get; init; }
        ...
        /// </summary>
        [JsonPropertyName("account_sequence_available")]
        public uint? AccountSequenceNext { get; init; }
        ...
        public string? OpenLedgerCost { get; init; }
        ...
        public int? ValidatedLedgerIndex { get; init; }
    }
}
