...
namespace XRPL.Core.Domain.Requests
{
    ...
    /// <para/><see cref="XRPToFTokenOffer"/> entries for orders that are currently live, unfunded, or expired but not yet removed.
    ...
    /// <para/><see cref="XRPCheck"/>, <see cref="FTokenCheck"/> entries for pending Checks.
    /// <para/><see cref="DepositPreauth"/> entries for deposit preauthorizations.
    /// <para/><see cref="Ticket"/> entries for Tickets.
    /// <para/><see cref="XRPToNFTokenOffer"/>, 
    /// <see cref="FTokenToNFTokenOffer"/>, 
    /// <see cref="FTokenToFTokenOffer"/> entries for offers to buy or sell an NFT.
